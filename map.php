    ...
    <div class="row container mt-4">
        ...
        <div class="col">
            ...
            <table class="w-100">
                <tbody>
                    <tr>
                        <td class="impair">Lundi <span>13h - 21h</span></td>
                    </tr>
                    <tr>
                        <td class="pair">Mardi <span>13h - 21h</span></td>
                    </tr>
                    <tr>
                        <td class="impair">Mercredi <span>9h - 21h</span></td>
                    </tr>
                    <tr>
                        <td class="pair">Jeudi <span>13h - 21h</span></td>
                    </tr>
                    <tr>
                        <td class="impair">Vendredi <span>9h - 21h</span></td>
                    </tr>
                    <tr>
                        <td class="pair">Samedi <span>9h - 21h</span></td>
                    </tr>
                    <tr>
                        <td class="impair">Dimanche <span>Fermé</span></td>
                    </tr>
                </tbody>
            </table>
        </div>
