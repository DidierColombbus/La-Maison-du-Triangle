...
<div class="container bg-light">
    ...
    <article class="text-start">
        ...
        2.5 Confidentialité L'abonné s'engage à limiter strictement l'accès aux services payants Dalloz disponibles sur les Services aux seuls utilisateurs finaux tels que visés dans la facture des Editions Dalloz.

        L’abonné est seul responsable d'une violation quelconque des obligations prévues aux présentes par l'un des utilisateurs finaux.
    ...
    <article class="text-start">
        ...
        Les Services Dalloz sont accessibles par le réseau Internet 24 heures sur 24 et 7 jours sur 7, sauf cas de force majeure, événement hors de contrôle de l’Editeur et/ou de l'hébergeur du service, pannes éventuelles ou interventions de maintenance nécessaires pour assurer le bon fonctionnement du service.
        Ces dernières ne donnent lieu à aucune indemnité.

        Un service d’assistance est à la disposition du client aux heures ouvrées de 9 H à 18 H du lundi au jeudi et de 9 H à 17 H le vendredi (sauf jour férié) au n° 01 40 92 20 85 ; ce service est limité à l’utilisation des services en ligne.
    ...
    <article class="text-start">
        ...
        - et/ou de reproduire ces pages sur papier à l'usage strictement privé de chaque utilisateur final, tels que visés dans la facture de l’Editeur.
