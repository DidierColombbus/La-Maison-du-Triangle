...
<article class="col-lg-8 col-md-6 col-sm-12 p-1 bg-light text-dark mt-1">
    ...
    <p>Le paradoxe d'un triangle réside dans sa singulière évocation du vide, car c'est un élément tout de métal dont les notes naissent dans un creux tracé par des extrémités qui n'oseront jamais se toucher. Il est aussi amusant pour un enfant qu'un cerceau filant au bout du baton. Il est aussi ridicule pour un adulte qu'un théorème à demi oublié. Mais c'est pour le percussionniste un challenge infini, tout vibrant de pureté. Le triangle tinte en gouttes cristallines, recluses, ceintes au gré des fines lignes.</p>
    <section>
      <div id="notresite">
